...
const AccountHover = ({ showUserIcon }) => {
  ...
  return (
    <div className="absolute z-50 right-10 mt-20 ">
      <div className="text-gray-200  text-xl  ml-52">
        
        <i class="fa-solid fa-caret-up "></i>
      
      </div>
      <div className=" text-white  w-64 bg-black bg-opacity-90 px-5 py-7">
        <div>
          ...
          <div
            ...
            className="w-full  pb-2 text-center text-white cursor-pointer hover:bg-red-800"
          >
            Sign out of Netfix
          </div>
        </div>
