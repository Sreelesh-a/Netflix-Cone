...
const VideoBGTitle = ({ title, overview,id }) => {
  return (
    <div className="w-full absolute z-50 sm:-bottom-11 -bottom-14 py-64 sm:px-12 px-8  left-0 text-white bg-gradient-to-t from-black ">
      <div className="">
        ...
        <div className="pt-5 flex gap-x-3">
          <button className="px-6 bg-white rounded-sm py-3 text-gray-900 font-bold">
            <i class="fa-solid fa-play mr-1"></i> Play
          </button>
          <Link to={`/movie/${id}`}>

          <button className="px-8 bg-gray-900 rounded-sm bg-opacity-25 py-3 text-white font-bold">
